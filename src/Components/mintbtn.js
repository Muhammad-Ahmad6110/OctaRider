        ...
        <div className="row align-items-center">
          {walletConnected == 0 ? (
            <div className="col-12">
              ...
              >
                <img src={ConnectWal} className="mx-auto MintImg d-block py-3"></img>
              </h3>
            </div>
          ) : (
            ""
            ...
            <>
              ...
              <div className="col-sm-12">
                <div className="d-flex justify-content-center align-items-center">
                  ...
                  <span className="quantity text-white font-weight-bold" style={{fontWeight : '200px'}}> {quantity} </span>
                  <button
